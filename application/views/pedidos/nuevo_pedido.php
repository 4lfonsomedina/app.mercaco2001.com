...
<ul class="nav nav-tabs pedido_nav">
  ...
  <li class="li_paso li_paso3" paso="3"><a data-toggle="tab" href="#finalizar"><i class="fa fa-check-square-o fa-2x" aria-hidden="true"></i></a></li>
</ul>
        ...
        <div class="panel-body formulario_pedido">
            ...
            <div class="pedido_div_direccion">
             <div class="col-xs-8"><input id="pedido_calle" type="text" class="form-control pedido_dir" placeholder="Calle" name="dir_calle"></div>
              ...
              <div class="col-xs-4"><input id="pedido_colonia" type="text" class="form-control pedido_dir" placeholder="Colonia" name="dir_colonia"></div>
              <div class="col-xs-8"><input id="pedido_referencias" type="text" class="form-control pedido_dir" placeholder="Referencia" name="referencia"></div>
...
<div id="pedido" class="tab-pane fade">
    <div class="col-sm-7 buscador_pedido"> 
        <div class="panel-heading cabecera_buscador">
            <form id="agregar_producto_form">
                <div class="row">
                    ...
                    <div class="col-xs-2">
                        <select class="form-control" name="unidad" id="f_unidad">
                            <option value="PZA">PZA</option>
                            <option value="KG">KG</option>
                        </select>
                    </div>
                    <div class="col-xs-8">
                        <select class="form-control chosen-select select_producto" placeholder="Producto" name="producto" id="f_producto">
                            <?php foreach($productos as $p){?>
                                <option value="<?=$p->producto?>"><?=number_format($p->precio,2)." ".$p->unidad." - ".$p->descripcion ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="col-xs-3">
                        <b>Preparado</b>
                        <select class="form-control" name="preparado" id="f_preparad">
                    ...
                    <div class="col-xs-3">
                        <b>Asado</b>
                        <select class="form-control" name="asado" id="f_asado">
                            <option value="0">NO</option>
                            <option value="1">Si</option>
                        </select>
                    </div>
                    <div class="col-xs-3">
                        <b>Termino</b>
                        <select class="form-control" name="termino" id="f_termino">
                    ...
                    <div class="col-xs-3">
                        <b>Corte</b>
                        <select class="form-control" name="corte" id="f_corte">
                            <option value="N">No Aplica</option>
                    ...
                    <div class="col-xs-10">
                        <br>
                        <input type="text" class="form-control" placeholder="Detalles del pedido" name="detalles" id="f_detalles">
                    </div>
                    <div class="col-xs-2">
                        <br>
        ...
        <div class="panel panel-default">
            <div class="panel-body panel_contenedor_articulo">
                 <div id="contenedor_articulo"></div>
            </div>
        </div>
    </div>
    <div class="col-sm-5">
        <div class="contenido_carrito" style="background-color: white;"></div>
    </div>
</div>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-6" style="text-align: right;">Atendido por:</div>
                        <div class="col-xs-6"><input type="text" class="form-control" name="tomo" id="atendido_por"></div>
                    </div>
                </div>
            </div>
        </div>
